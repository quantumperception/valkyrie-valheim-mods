...
namespace ZonePermissions
{
    ...
    public static class Client
    {
        ...
        public static bool IsZoneAdmin = false;
        ...
        public static ZPackage Serialize()
        {
            ...
            //if (false /*ValheimPermissions.ValheimDB.CheckUserAbsolutePermission(SteamID, "HackShardGaming.WoV-Zones.Wards.Override")*/)
            //{
            //    zip.Write(false);
            //    zip.Write(false);
            //    zip.Write(false);
        ...
        public static void RPC(long uid, ZPackage data)
        {
            Debug.Log("S2C Client (RPC Call)");
            Debug.Assert(!ZNet.instance.IsServer());
#if DEBUG
